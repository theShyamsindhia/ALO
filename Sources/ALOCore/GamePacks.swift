...
public struct GamePackDescriptor: Codable, Sendable, Equatable, Identifiable {
    ...
    public var supported: Bool {
        (id == "rift-arena" && ["rift-arena-v1", "rift-arena-v2", "rift-arena-v3", "rift-arena-v4"].contains(engine)) || (id == "fourfold" && engine == "fourfold-v1")
    }
...
public struct GamePackContent: Codable, Sendable, Equatable {
    ...
    public let expandedFighterImageBase64: String?
    public var expandedFighterImageData: Data? { expandedFighterImageBase64.flatMap { Data(base64Encoded: $0) } }
    public let platformImageBase64: String?
    public var platformImageData: Data? { platformImageBase64.flatMap { Data(base64Encoded: $0) } }
    ...
    public init(id: String, engine: String, version: Int, arenaName: String, subtitle: String, accentHex: String, backgroundImageBase64: String? = nil, fighterImageBase64: String? = nil, gardenImageBase64: String? = nil, midgroundImageBase64: String? = nil, platformImageBase64: String? = nil, expandedFighterImageBase64: String? = nil) {
        self.expandedFighterImageBase64 = expandedFighterImageBase64
        self.platformImageBase64 = platformImageBase64
    ...
    public static func verify(_ data: Data, descriptor: GamePackDescriptor) throws -> GamePackContent {
        ...
        for image in [pack.backgroundImageBase64, pack.fighterImageBase64, pack.gardenImageBase64, pack.midgroundImageBase64, pack.platformImageBase64, pack.expandedFighterImageBase64].compactMap({ $0 }) {
