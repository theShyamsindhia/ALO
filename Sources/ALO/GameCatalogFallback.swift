...
enum GameCatalogFallback {
    static let games = [
        GamePackDescriptor(id: "rift-arena", engine: "rift-arena-v3", title: "Rift Arena", summary: "A room platform fighter for up to four players. Add bots, join a round, or watch.", version: 3, url: URL(string: "https://raw.githubusercontent.com/theShyamsindhia/ALO/main/GamePacks/rift-arena/3/pack.json")!, sha256: "bfb12d31cc6b16502dbcbac14369fe0b4ce5e3c115974fbd63d673c8b713148e", bytes: 2724216),
