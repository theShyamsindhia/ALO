...
final class SourceMuteTap {
    ...
    func start() throws {
        ...
        do {
            ...
            var tapListAddress = Self.propertyAddress(
            ...
            try check(
                ...
                operation: "inspect the private tap device"
            )
            var tapList: CFArray?
            try withUnsafeMutablePointer(to: &tapList) { pointer in
                try check(
                    ...
                    operation: "read the private tap list"
                )
            }
            ...
            try check(
                AudioDeviceCreateIOProcIDWithBlock(
                    ...
                    // Reading the tap activates .mutedWhenTapped. ScreenCaptureKit owns capture.
                },
