...
entries = [
    dict(version=4, id="rift-arena", engine="rift-arena-v4", title="Rift Arena", summary="A room platform fighter for up to four players. Add bots, join a round, or watch.", arenaName="The Hollow", subtitle="A quiet sky. A friendly rivalry.", accentHex="A2ADBE"),
...
for entry in entries:
    ...
    if entry["id"] == "rift-arena":
        for field, filename in [("backgroundImageBase64", "hollow-observatory.jpg"), ("fighterImageBase64", "fighters.png"), ("gardenImageBase64", "moon-garden.jpg"), ("midgroundImageBase64", "garden-islands.png"), ("platformImageBase64", "arena-stone.png"), ("expandedFighterImageBase64", "fighters-expanded.png")]:
